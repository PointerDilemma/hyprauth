...
class CPamConversationManagerV1Spec : public Hyprwire::IProtocolObjectSpec {
  public:
    CPamConversationManagerV1Spec() = default;
    virtual ~CPamConversationManagerV1Spec() = default;

    virtual std::string objectName() {
        return "pam_conversation_manager_v1";
    }
...
.idx = 0,
.params = {  },
.returnsType = "pam_conversation_v1",
.since = 0,
}
    };
...
class CHyprauthPamV1ProtocolSpec : public Hyprwire::IProtocolSpec {
  public:
    ...
    virtual std::vector<Hyprutils::Memory::CSharedPointer<Hyprwire::IProtocolObjectSpec>> objects() {
        return { Hyprutils::Memory::makeShared<CPamConversationManagerV1Spec>(), Hyprutils::Memory::makeShared<CPamConversationV1Spec>() };
    }
};
